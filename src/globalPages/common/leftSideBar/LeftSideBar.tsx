      ...
      <div className="sidebar-items">
        ...
        <Link to="./salesgrid" className="link-text">
          <div className="item">
            ...
            <Typography className="sidebar-text fs-12">Salesgrid</Typography>{" "}
          </div>
        </Link>
        <Link to="/orders" className="link-text">
          <div className="item" onClick={handleClickOrders}>
            ...
            <Typography className="sidebar-text fs-12">Orders</Typography>
            {openOrders ? " " : " "}
          </div>
        </Link>
        <Collapse in={openOrders} timeout="auto">
          <div className="sidebar-text">
            ...
            <ListItemButton className="padding-left">
              <Typography className="fs-12 ">Late Fulfillment</Typography>
            </ListItemButton>
            <ListItemButton className="padding-left">
              <Typography className="fs-12 ">Late Pickup</Typography>
            </ListItemButton>
            <ListItemButton className="padding-left">
        ...
        <Link to="/contracts" className="link-text">
          <div className="item" onClick={handleClickContracts}>
            ...
            <Typography className="sidebar-text fs-12">Contracts</Typography>
            {openContracts ? " " : " "}
          </div>
        </Link>
        <Collapse in={openContracts} timeout="auto">
          <div className="sidebar-text fs-12">
            <Link to="/salesgrid" className="link-text">
              <ListItemButton className="padding-left">
                <Typography className="fs-12">Active</Typography>
              </ListItemButton>
            </Link>
            <ListItemButton className="padding-left">
        ...
        <Link to="/contracts" className="link-text">
          <div className="item">
            ...
            <Typography className="sidebar-text fs-12">People</Typography>{" "}
          </div>
        </Link>
        <Link to="/contracts" className="link-text">
          <div className="item">
            <BusinessOutlinedIcon className="sidebar-icon" />{" "}
            <Typography className="sidebar-text fs-12">Facilities</Typography>{" "}
          </div>
        </Link>
        ...
        <Link to="/contracts" className="link-text">
          <div className="item">
            ...
            <Typography className="sidebar-text fs-12">Recent Items</Typography>{" "}
          </div>
        </Link>
      </div>
    </div>
