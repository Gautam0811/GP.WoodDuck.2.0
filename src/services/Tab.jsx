...
function WD_CPUcreateData(value) {
  ...
  export const WD_Buyersgrouprows = [
    ...
    WD_BuyersgroupcreateData("value 3"),
  ];



  function WD_MBFcreateData(value) {
    return { value,key: Math.random() };
  }
  
  export const WD_MBFrows = [
    WD_MBFcreateData(0)
  ];


  function WD_MillcreateData(value) {
    return { value,key: Math.random() };
  }
  
  export const WD_Millrows = [
    WD_MillcreateData("ROCKY CREEK"),
    WD_MillcreateData("GP SL WARRENTON ll"),
    WD_MillcreateData("DUDLEY STUD"),
    WD_MillcreateData("PROSPERITY STUD"),
    WD_MillcreateData("THOMSO-R"),
    WD_MillcreateData("CHICAGO-R"),
    WD_MillcreateData("CAMDEN"),
  ];