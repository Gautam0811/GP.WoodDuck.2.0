...
import * as ActivateManageUsersConstant from '../../../../../common/constant/ActivateManageUsersConstant';
...
export function ActivateManageUsersModal(props: ActivateManageUsersModalProps) {
	...
	const handleClickSaveActivate = () => {
		...
		setNotifyActivate({
			isOpen: true,
			message: String(ActivateManageUsersConstant.FIRST_YES_MESSAGE),
			message2: String(ActivateManageUsersConstant.SECOND_YES_MESSAGE),
			type: 'success',
		});
		closeActivateModal();
	};
	...
	const cancelActivateModal = () => {
		...
		setNotifyActivate({
			isOpen: true,
			message: String(ActivateManageUsersConstant.FIRST_NO_MESSAGE),
			message2: String(ActivateManageUsersConstant.SECOND_NO_MESSAGE),
			type: 'error',
		});
		closeActivateModal();
	};
