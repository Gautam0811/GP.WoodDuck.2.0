		...
		<Box className="border-radius-5 box-shad-125grey w30 bg-white mx-32 my-8">
			...
			<Stack spacing={0.2} className="p-8">
				<Link to="#" className="text-dec-none">
					<Typography className="col-005fa8">Activity Log</Typography>
				</Link>
				<Link to="#" className="text-dec-none">
					<Typography className="col-005fa8">API Log</Typography>
				</Link>
				<Link to="#" className="text-dec-none">
				...
				<Link to="#" className="text-dec-none">
					<Typography className="col-005fa8">Error Log</Typography>
				</Link>
				<Link to="#" className="text-dec-none">
					<Typography className="col-005fa8">
						Search Status
